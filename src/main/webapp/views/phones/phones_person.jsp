...
<%--Повідомлення при завантаженні у вигляді модального вікна--%>
<%--https://www.schoolsw3.com/howto/howto_js_alert.php--%>
...
<div class="header1">
    <div class="header-right">
        <li><h1>Власник: <span>${owner.initialsToString()}</span></h1></li>
        <li><a href="${ref_to_return}">Повернутися</a></li>
    </div>
</div>
<%--&lt;%&ndash;--%>
...
<div>
    <form action="add_phone">
        ...
        <input class="buttonfortable" type="submit" value="Додати телефон">
    </form>
</div>
<div>
